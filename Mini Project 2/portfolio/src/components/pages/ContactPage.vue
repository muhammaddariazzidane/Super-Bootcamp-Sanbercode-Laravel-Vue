...
<template>
  <main>
    <h1 class="font-semibold sm:text-2xl text-base mb-4">Contact me</h1>
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div class="flex gap-5 flex-col mt-5">
        ...
        <a
          ...
          <p class="font-medium">Instagram</p> </a
        ><a
          aria-label="Linkedin"
          class="flex items-center gap-4"
          ...
          <p class="font-medium">Linkedin</p> </a
        ><a
          aria-label="X"
          class="flex items-center gap-4"
      ...
      <div class="col-span-2">
        <form class="flex flex-col gap-4 shadow rounded-md p-4">
          <div>
